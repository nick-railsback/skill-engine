...
# run-eval.sh parameterized template for the library-context navigator.
#
# This is a TEMPLATE. Replace placeholders before use:
# library           - your domain stem (used in invocation prompt + output header)
#
...
{
  printf '{\n'
  printf '  "navigator": "library-context",\n'
